...
public class PsSmallApp {

    private static final Logger log = LoggerFactory.getLogger(PsSmallApp.class);

    private final Environment env;

    public PsSmallApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(PsSmallApp.class);
